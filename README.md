...
Preprocessing is a way to extend css capabilities and it lets you use features such as nesting, mixins, math operations, etc.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

Nesting was my favorite part, really easy to understand and useful as well. I don't have any troubles with css.

3. How would you explain the concept of a variable to someone new to programming?

Variables is bassically putting some sort of value to a word, or something that is easy to use instead of using the value itself. 

4. What is the purpose of using functions in code?

It is a block that help you not repeat yourself and work in a more efficent way. 

5. What is a JSON data?

'Javascript Object Notation is an open standard file format that let programmers understand more easily and program in javascript by using our language instead of computer language. 
